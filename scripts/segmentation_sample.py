...
def main():
    ...
    # model.load_state_dict(th.load(args.model_path, map_location="cuda"))
    ...
    dataset = CrowdDataset_shangheiTech(
    ...
    while len(all_images) * args.batch_size < args.num_samples:
        ...
        for i in range(
            ...
            sample, x_noisy, org = sample_fn(
                model,
                (args.batch_size, 4, args.image_size, args.image_size),     # shape of noise
                img,
            ...
            th.cuda.synchronize()
            print(
                "time for 1 sample", start.elapsed_time(end)
...
def create_argparser():
    defaults = dict(
        data_dir="./data/ShanghaiTech/part_A/test_data",
        clip_denoised=True,
        num_samples=1,
        batch_size=1,
        use_ddim=False,
